...
var action_repository_1 = require("./action.repository");
var ActionService = /** @class */ (function () {
    function ActionService() {
        ...
        this.create = function (payload) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.actionRepository.addAction(payload)];
                    case 1:
                        action = _a.sent();
        ...
        this.getAll = function (query) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.actionRepository.getActions(query)];
                    case 1:
                        actions = _a.sent();
        ...
        this.getById = function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.actionRepository.getActionById(id)];
                    case 1:
                        action = _a.sent();
                        return [2 /*return*/, action];
                    case 2:
        ...
        this.deleteById = function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.actionRepository.deleteAction(id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, "Action removed successfully"];
                    case 2:
                        error_4 = _a.sent();
                        throw error_4;
                    case 3: return [2 /*return*/];
        ...
        this.updateById = function (id, payload) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.actionRepository.updateAction(id, payload)];
                    case 1:
                        action = _a.sent();
                        return [2 /*return*/, action];
                    case 2:
        ...
        this.actionRepository = new action_repository_1.ActionRepository(action_model_1.default);
    }
