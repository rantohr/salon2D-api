...
var ProjectService = /** @class */ (function () {
    function ProjectService() {
        ...
        this.create = function (payload) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.projectRepository.addProject(payload)];
                    case 1:
                        project = _a.sent();
        ...
        this.getAll = function (query) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.projectRepository.getProjects(query)];
                    case 1:
                        projects = _a.sent();
        ...
        this.getById = function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.projectRepository.getProjectById(id)];
                    case 1:
                        project = _a.sent();
                        return [2 /*return*/, project];
                    case 2:
        ...
        this.deleteById = function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.projectRepository.deleteProject(id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, "Project removed successfully"];
                    case 2:
                        error_4 = _a.sent();
                        throw error_4;
                    case 3: return [2 /*return*/];
        ...
        this.updateById = function (id, payload) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.projectRepository.updateProject(id, payload)];
                    case 1:
                        project = _a.sent();
                        return [2 /*return*/, project];
                    case 2:
        ...
        this.projectRepository = new project_repository_1.ProjectRepository(project_model_1.default);
    }
