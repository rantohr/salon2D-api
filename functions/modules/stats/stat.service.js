...
var stat_model_1 = require("./stat.model");
var stat_repository_1 = require("./stat.repository");
var StatService = /** @class */ (function () {
    function StatService() {
        ...
        this.create = function (payload) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.statRepository.addStat(payload)];
                    case 1:
                        stat = _a.sent();
        ...
        this.getAll = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.statRepository.getStats()];
                    case 1:
                        stats = _a.sent();
        ...
        this.getById = function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.statRepository.getStatById(id)];
                    case 1:
                        stat = _a.sent();
                        return [2 /*return*/, stat];
                    case 2:
        ...
        this.deleteById = function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.statRepository.deleteStat(id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, "Stat removed successfully"];
                    case 2:
                        error_4 = _a.sent();
                        throw error_4;
                    case 3: return [2 /*return*/];
        ...
        this.updateById = function (id, payload) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.statRepository.updateStat(id, payload)];
                    case 1:
                        stat = _a.sent();
                        return [2 /*return*/, stat];
                    case 2:
        ...
        this.statRepository = new stat_repository_1.StatRepository(stat_model_1.default);
    }
    return StatService;
}());
