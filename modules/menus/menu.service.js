...
var menu_repository_1 = require("./menu.repository");
var MenuService = /** @class */ (function () {
    function MenuService() {
        ...
        this.create = function (payload) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.menuRepository.addMenu(payload)];
                    case 1:
                        menu = _a.sent();
        ...
        this.getAll = function (query) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.menuRepository.getMenus(query)];
                    case 1:
                        menus = _a.sent();
        ...
        this.getById = function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.menuRepository.getMenuById(id)];
                    case 1:
                        menu = _a.sent();
                        return [2 /*return*/, menu];
                    case 2:
        ...
        this.deleteById = function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.menuRepository.deleteMenu(id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, "Menu removed successfully"];
                    case 2:
                        error_4 = _a.sent();
                        throw error_4;
                    case 3: return [2 /*return*/];
        ...
        this.updateById = function (id, payload) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.menuRepository.updateMenu(id, payload)];
                    case 1:
                        menu = _a.sent();
                        return [2 /*return*/, menu];
                    case 2:
        ...
        this.menuRepository = new menu_repository_1.MenuRepository(menu_model_1.default);
    }
    return MenuService;
}());
