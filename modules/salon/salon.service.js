...
var salon_model_1 = require("./salon.model");
var salon_repository_1 = require("./salon.repository");
        ...
        this.create = function (payload) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.salonRepository.addSalon(payload)];
                    case 1:
                        salon = _a.sent();
        ...
        this.getAll = function (query) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.salonRepository.getSalons(query)];
                    case 1:
                        salon = _a.sent();
                        return [2 /*return*/, salon];
                    case 2:
        ...
        this.getById = function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.salonRepository.getSalonById(id)];
                    case 1:
                        salon = _a.sent();
                        return [2 /*return*/, salon];
                    case 2:
        ...
        this.deleteById = function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.salonRepository.deleteSalon(id)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, "Salon removed successfully"];
                    case 2:
                        error_4 = _a.sent();
                        throw error_4;
                    case 3: return [2 /*return*/];
        ...
        this.updateById = function (id, payload) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.salonRepository.updateSalon(id, payload)];
                    case 1:
                        salon = _a.sent();
                        return [2 /*return*/, salon];
                    case 2:
